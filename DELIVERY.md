...
已预置4条交易记录（**价格已根据2025年实际市场情况调整**）：
1. 2025年度风电绿色电力证书交易项目（通道，单价7.20元）
2. 光伏绿证采购项目（第一批）（非通道，单价6.80元）
3. 分布式光伏绿证交易项目（通道，单价7.35元）
4. 集中式风电绿证交易（第二批）（非通道，单价6.58元）

**⚠️ 重要说明**：
- 绿证单价已调整为符合2025年实际市场价格（约7元人民币/张）
- 详情链接字段为空，因为这些是演示数据
