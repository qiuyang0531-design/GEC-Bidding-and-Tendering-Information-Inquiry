...
8. ✅ 通道类型 (is_channel) - 布尔值或null（通道/非通道/未标注）
9. ✅ 绿证年份 (cert_year) - 文本类型（支持单年份"2025"或多年份"2024/2025"）
10. ✅ 招标开始日期 (bid_start_date) - 日期格式
11. ✅ 招标结束日期 (bid_end_date) - 日期格式
12. ✅ 中标日期 (award_date) - 日期格式
